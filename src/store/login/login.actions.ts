...
export const recoverPasswordSuccess = createAction("[Recoverpassword] success");
export const recoverPassswordFail = createAction("[Recover password] fail", props<{error: any}>());
